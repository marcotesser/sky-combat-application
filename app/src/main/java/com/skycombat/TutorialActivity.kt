...
class TutorialActivity : AppCompatActivity() {
    ...
    private fun getSlideText(numSlide: Int):String {
        when(numSlide){
            1-> return "Accedi all’area autenticazione per mezzo del pulsante cerchiato, li potrai eseguire il login inserendo le tue credenziali.\n\nSe invece devi ancora registrarti seleziona il link: “Sign up” dell’area autenticazione.\n\nUna volta autenticato potrai accedere alla modalità: “MULTI PLAYER”."
            2-> return "Per visualizzare le classifiche ti basterà cliccare l’icona raffigurante una medaglia nella schermata principale.\n\nCliccando “PLAYER DEFEATED” potrai osservare la classifica delle partite multiplayer, il pulsante “MAX SCORE” invece ti mostrerà quella delle partite in single player."
            3-> return "Potrai accedere al gioco scegliendo una delle due modalità disponibili identificate dai tasti cerchiati.\n\nL’obbiettivo del gioco può essere: rimanere in vita più tempo possibile (singleplayer) oppure sconfiggere il più alto numero di nemici (multiplayer).\n\nPer interagire con il gioco ti basterà muovere trascinare la tua navicella trasversalmente sullo schermo, e non preoccuparti.. lo sparo è automatico!"
            4-> return "La partita multiplayer comincerà quando saranno presenti nella lobby di attesa tra i 2 e i 6 giocatori.\n\nGli avversari saranno rappresentati da navicelle semitrasparenti e non avranno influenza sul tuo gioco.\n\nSe sei stato eliminato prima della fine partita potrai tornare alla schermata principale cliccando il pulsante “QUIT”."
            else -> return ""
        }
    }
